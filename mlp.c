...
int main()
{
    // Creating our dataset i.e the XOR function
    ...
    // Converting dataset to tensors and initializing weights and biases
    // The MLP will have one hidden layer of 4 neurons
